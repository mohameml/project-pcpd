...
public:
    ...
    void price(double t, double &price, double &price_std, const PnlMat *Past, PnlVect *deltas_vect, PnlVect *stddev_deltas_vect);
    void get_past(double t, PnlMat *cots, PnlMat *market_data);
